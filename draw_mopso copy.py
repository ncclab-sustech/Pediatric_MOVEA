...
index = cal_rank(1 / data[index1, 0],0.02)
...
plt.scatter(1/data[index1[index], 0], data[index1[index], 1], s=30, c='#F73030', marker='v', label='Motor : '+ str(np.around(parameter[0],decimals=2))+'*X+'+str(np.around(parameter[1],decimals=2)))
...
data = np.array(gt_data)
index1 = np.argsort(1/data[:,0])
index = np.argsort(rank_dense(data[index1,0]))
parameter = np.polyfit(1 / data[index, 0],data[index, 1],2)
plt.scatter(1/data[index[RES:], 0], data[index[RES:], 1], s=30,  c='#548235', marker='v', label='DLPFC : '+ str(np.around(parameter[0],decimals=2))+'*X^2'+str(np.around(parameter[1],decimals=2))+'*X+'+str(np.around(parameter[2],decimals=2)))
p = np.poly1d(parameter)
...
index = np.argsort(rank_dense(data[index1,0]))
parameter = np.polyfit(1 / data[index, 0],data[index, 1],2)
plt.scatter(1/data[index[RES:], 0], data[index[RES:], 1], s=30,  c='#C55A11', marker='v', label='V1 : '+ str(np.around(parameter[0],decimals=2))+'*X^2'+str(np.around(parameter[1],decimals=2))+'*X+'+str(np.around(parameter[2],decimals=2)))
p = np.poly1d(parameter)
...
index = np.argsort(rank_dense(data[index1,0]))
parameter = np.polyfit(1 / data[index, 0],data[index, 1],2)
plt.scatter(1/data[index[RES:], 0], data[index[RES:], 1], s=30,  c='#ef8b8b', marker='v', label='Hippocampus : '+ str(np.around(parameter[0],decimals=2))+'*X^2'+str(np.around(parameter[1],decimals=2))+'*X+'+str(np.around(parameter[2],decimals=2)))
p = np.poly1d(parameter)
...
index = np.argsort(rank_dense(data[index1,0]))
parameter = np.polyfit(1 / data[index, 0],data[index, 1],2)
plt.scatter(1/data[index[RES:], 0], data[index[RES:], 1],  c='#00b0f0', s=30, marker='v', label='Pallidum : '+ str(np.around(parameter[0],decimals=2))+'*X^2'+str(np.around(parameter[1],decimals=2))+'*X+'+str(np.around(parameter[2],decimals=2)))
p = np.poly1d(parameter)
...
index = np.argsort(rank_dense(data[index1,0]))
parameter = np.polyfit(1 / data[index, 0],data[index, 1],2)
plt.scatter(1/data[index[RES:], 0], data[index[RES:], 1], s=30, c='gold', marker='v', label='Thalamus : '+ str(np.around(parameter[0],decimals=2))+'*X^2'+str(np.around(parameter[1],decimals=2))+'*X+'+str(np.around(parameter[2],decimals=2)))
p = np.poly1d(parameter)
...
parameter = np.polyfit(1 / data[index, 0],data[index, 1],1)
#plt.scatter(1/data[index, 0], data[index, 1],  c='#F73030', marker='1', label='Motor : '+ str(np.around(parameter[0],decimals=2))+'*X^2'+str(np.around(parameter[1],decimals=2))+'*X+'+str(np.around(parameter[2],decimals=2)))
plt.scatter(1/data[index, 0], data[index, 1], s=30,  c='#F73030', marker='o', label='Motor : '+ str(np.around(parameter[0],decimals=2))+'*X+'+str(np.around(parameter[1],decimals=2)))
p = np.poly1d(parameter)
...
#
# plt.xlim(0.09, 0.49, 0.08)
# plt.xticks(np.arange(0.09, 0.5, 0.08),size =10)
# plt.ylim(0, 0.25, 0.05)
# plt.yticks(np.arange(0.05, 0.25, 0.05),size =10)
